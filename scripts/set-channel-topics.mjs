...
const TOPICS = {
  ...
  '🧭-인프라-개요':
    '인프라와 Cloud 개념, 가상화. Track A 의 출발점입니다.',
  '🌐-네트워크':
  ...
  // TRACK B · C (비공개 — 진도 나가면 공개)
  '🔀-git-cicd':
    'Git, CI/CD, GitOps. 진도가 나가면 공개합니다.',
  '📊-모니터링':
    'Prometheus, Grafana. 진도가 나가면 공개합니다.',
  '🔎-로그-관측':
    'ELK, Loki. 진도가 나가면 공개합니다.',
  '🤖-mlops':
    'AWS Bedrock, MLOps. 진도가 나가면 공개합니다.',
